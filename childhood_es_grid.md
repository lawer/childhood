...
![Ilustración estilo garabato noventero para el capítulo «Crear la pandilla».](images/crear-la-pandilla.png)
...
![Ilustración estilo garabato noventero para el capítulo «Equipo, tiendas y cachivaches».](images/equipo-tiendas-y-cachivaches.png)
...
![Ilustración estilo garabato noventero para el capítulo «Reglas de juego».](images/reglas-de-juego.png)
...
<figure class="gameboy-map">
  <img src="maps/despliegue-basico-gameboy.svg" alt="Mapa estilo Game Boy de un tablero 12 por 12 con Spawns en los bordes, objetivo central y escenografía.">
...
![Ilustración estilo garabato noventero para el capítulo «Cómo funciona la campaña».](images/c-mo-funciona-la-campa-a.png)
...
![Ilustración estilo garabato noventero para el capítulo «Episodio 1 — Empiezan las vacaciones».](images/episodio-1-empiezan-las-vacaciones.png)
...
<figure class="enemy-plate">
  <img src="images/enemigos-episodio-1.png" alt="Lámina bitmap de enemigos iniciales: gato sarnoso, gran gato satánico, mordedor de tobillo y robot triste, estilo garabato noventero.">
...
<figure class="gameboy-map">
  <img src="maps/aventura-1-puertas-gameboy.svg" alt="Mapa estilo Game Boy para la Aventura 1 con casas, puertas, Spawns y gatos entrando por los bordes.">
...
![Ilustración estilo garabato noventero para el capítulo «Episodio 2 — Street Fighters».](images/episodio-2-street-fighters.png)
...
<figure class="enemy-plate">
  <img src="images/enemigos-episodio-2.png" alt="Lámina bitmap de enemigos del episodio 2: cerdito furtivo, vaca loca, cerdo de artillería y matón callejero, estilo garabato noventero.">
...
<figure class="gameboy-map">
  <img src="maps/cruce-campo-seguro-gameboy.svg" alt="Mapa estilo Game Boy de la ruta rural: zona de despliegue, zona segura, Spawns de malos y Marcadores Furtivos.">
...
<figure class="gameboy-map">
  <img src="maps/fuerte-central-gameboy.svg" alt="Mapa estilo Game Boy de un fuerte central 4 por 4 con enemigos apareciendo desde Spawns de borde.">
...
<figure class="gameboy-map">
  <img src="maps/huida-alcantarilla-gameboy.svg" alt="Mapa estilo Game Boy con alcantarilla central, despliegues opuestos y matones bloqueando el avance.">
...
<figure class="gameboy-map">
  <img src="maps/cruce-alcantarillas-gameboy.svg" alt="Mapa estilo Game Boy de un cruce de alcantarillas con túneles de 4 casillas, tres mutantes centrales, despliegues opuestos y Desastres.">
...
![Ilustración estilo garabato noventero para el capítulo «Interludio — Nos vamos de pesca».](images/interludio-nos-vamos-de-pesca.png)
...
![Ilustración estilo garabato noventero para el capítulo «Episodio 3 — Pillados con las manos en la masa».](images/episodio-3-pillados-con-las-manos-en-la-masa.png)
...
<figure class="enemy-plate">
  <img src="images/enemigos-episodio-3.png" alt="Lámina bitmap de enemigos del episodio 3: duendes, matón duende, Ratoncito Pérez y padre furioso, estilo garabato noventero.">
...
<figure class="gameboy-map">
  <img src="maps/frigorifico-duendes-gameboy.svg" alt="Mapa estilo Game Boy con frigorífico central, Duendes entrando por Spawns y ruta de huida al borde.">
...
<figure class="gameboy-map">
  <img src="maps/fuerte-central-gameboy.svg" alt="Mapa estilo Game Boy de fuerte central 4 por 4 con Duendes apareciendo desde los bordes.">
...
<figure class="gameboy-map">
  <img src="maps/casa-camas-gameboy.svg" alt="Mapa estilo Game Boy de una casa con camas separadas, Spawns de malos y Ratoncito Pérez en el interior.">
...
![Ilustración estilo garabato noventero para el capítulo «Episodio 4 — Reino trágico».](images/episodio-4-reino-tr-gico.png)
...
5. Combate.
1. Determinar la iniciativa se determina de la manera habitual.
...
6. Especial, cualquier objeto usado sobre la sustancia viscosa se empapa.
5. Descubres la cabeza de un enorme robot de hierro en uno de los trasteros. Se ve muy triste y sientes una tristeza desgarradora al mirarlo. Un peque adquiere la habilidad Entristecido.
6. Uno de los peques presiona un botón y se abre una puerta oculta. ¡Has encontrado el laboratorio secreto de Dexter! Dexter no está muy contento de verte y te echa, pero no antes de que logres robar un gobernante de su escritorio.
7. Una máquina de embalaje parece haberse vuelto un poco loca, sigue escupiendo cajas de envío con la etiqueta Black Mesa RF.
...
8. ¡Parece que la Compañía de Energía Eléctrica hizo un mal trabajo porque acaban de cortar la energía! Cambie el clima a la noche.
Si ya era de noche entonces no te das cuenta del percance.

9. Metes la nariz donde no corresponde y encuentras el Guyver y una tostadora vieja.
...
10. ¡Alguien debe haber olvidado cerrar las jaulas porque los sujetos de prueba ahora están por todas partes! Añade D6 gatos sarnosos al tablero.
11. Un ratón blanco con aspecto loco murmura algo acerca de conquistar el mundo antes.
...
4. Friki
5. Chuletón
6. Media pinta Por derrotar a Stockmann, el científico loco. Apodo del jefe: 1. Megacerebro.
2. Robonik
3. El cerebro
4. profesor
5. tripa de gato
...
![Ilustración estilo garabato noventero para el capítulo «Campaña y progreso».](images/campa-a-y-progreso.png)
...
nombre del peque:____Apodo_  
Estadísticas  
Corazón_____+5= HP_____  
...
![Ilustración estilo garabato noventero para el capítulo «Anexos y tablas D100».](images/anexos-y-tablas-d100.png)
...
![Mapa imprimible 12×12: El Vecindario](maps/printable/el-vecindario-12x12.png)
...
![Mapa imprimible 12×12: El Cuartel General](maps/printable/el-cuartel-general-12x12.png)
...
![Mapa imprimible 12×12: El Patio del Colegio](maps/printable/el-patio-del-colegio-12x12.png)
...
![Mapa imprimible 12×12: El Recreativos](maps/printable/el-recreativos-12x12.png)
...
# Anexo — Normas oficiales sin adaptar a casillas
...
- Las miniaturas pueden moverse en cualquier dirección o combinación de direcciones, hasta su máximo de movimiento.
- Cuando una regla indica estar “a 1 pulgada”, mide desde la miniatura u objeto según el acuerdo de mesa habitual.
- Las armas a distancia tienen un alcance máximo de **12 pulgadas**, salvo que una regla indique otra cosa.
- Cualquier arma puede arrojarse hasta **6 pulgadas**, aplicando el penalizador indicado en combate a distancia.

## Preparar y jugar una partida

1. Elige una aventura.
2. Prepara la mesa según indique la aventura.
3. Determina el clima.
4. Despliega las pandillas según indique la aventura.
5. Determina quién actúa primero mediante iniciativa.

Cada ronda:

1. Determina la iniciativa de esa ronda.
2. Los jugadores se turnan para gastar Ánimo y activar peques hasta que todos se queden sin Ánimo disponible.
3. Activa a los Malos que haya en juego.
4. Tira 1D6: con 5+ ocurre un evento aleatorio. Cuando ya haya ocurrido un evento, no se vuelve a tirar por eventos futuros.
5. Termina la ronda.

## Pifias y críticos

- Un **1 natural** siempre falla y cuenta como **pifia**.
- Un **20 natural** antes de modificadores es un **crítico**.
- Los críticos en combate cuerpo a cuerpo y a distancia causan **+1 daño**.
...
- El Ánimo nunca puede superar **10**.
- Si baja por debajo de **1**, la pandilla se disuelve y la campaña se pierde.
- Aunque el Ánimo de la pandilla esté por debajo de **6**, los jugadores pueden contarlo como **6** durante una aventura.
...
- Usar un objeto o habilidad.
- Recoger y/o soltar cualquier número de objetos del suelo o de Malos derrotados que estén a **1 pulgada**.
- Interactuar con tesoros o elementos específicos de la aventura que estén a **1 pulgada**.
...
Puedes mover en cualquier dirección o combinación de direcciones hasta el máximo de movimiento del peque.

- El terreno de menos de **1 pulgada** de altura puede cruzarse gratis.
- El terreno de más de **1 pulgada** debe escalarse.
- Los peques escalan a la mitad de su velocidad de movimiento.
- Un peque debe terminar su movimiento sobre una superficie plana.
- Los peques pueden saltar huecos de **3 pulgadas** o menos, pero deben superar una prueba de **Cuerpo DR12**.
- Si fallan el salto, caen y sufren una consecuencia.
- Con una pifia en el salto, sufren dos consecuencias.
- Un peque que sale por un borde del tablero se considera que se ha ido a casa y deja de participar en la aventura.
...
## Combate cuerpo a cuerpo oficial
...
2. Elige un arma.
3. Haz una prueba **DR12** usando el modificador apropiado del arma.
4. Si el ataque impacta, tira el daño.
...
- Las miniaturas trabadas en cuerpo a cuerpo no pueden hacer ataques a distancia.
- Disparar contra miniaturas trabadas en cuerpo a cuerpo aplica **-3** a la tirada para impactar.
- Si más del 50% de una miniatura está oculto, aplica **-3** a la tirada para impactar: el objetivo tiene cobertura.
- Otra miniatura que bloquee la línea de visión también puede proporcionar cobertura.
...
- Los críticos causan **+1 daño**.
- La armadura se aplica incluso contra críticos.
...
- Si supera la prueba, actúa con normalidad.
- Si falla de nuevo, continúa moviéndose hacia fuera del tablero.
- Repite la prueba cada vez que sea elegido para activarse hasta que tenga éxito o abandone la mesa.
...
- Recibe un impacto crítico.
- Una aventura lo indica.
- Otro peque sufre la consecuencia **Agotado** a **12 pulgadas** o menos. Esta última condición solo afecta a miniaturas controladas por jugadores.

## Consecuencias y estados
